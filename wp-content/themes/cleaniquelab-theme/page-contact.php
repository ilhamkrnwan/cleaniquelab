...
<!-- HERO SECTION KONTAK -->
<section class="cq-hero cq-contact-hero">
    <div class="cq-container">
        <span class="cq-hero-eyebrow">Layanan &amp; Saluran Resmi</span>
        <h1 class="cq-hero-h1 cq-contact-hero-h1">Konsultasi &amp; Kontak Pabrik</h1>
...
<!-- SECTION KONTEN & FORMULIR DENGAN SALURAN RESMI & MARKETPLACE -->
<section class="cq-section cq-contact-section">
    <div class="cq-container">
        <div class="cq-contact-hero-grid">
            <!-- Kolom Kiri: Info Kontak & Marketplace -->
            <div class="cq-contact-info-col">
                <h2 class="cq-contact-title">
                    Saluran Komunikasi Resmi
                </h2>
                <p class="cq-contact-subtitle">
                    Hubungi tim kami via WhatsApp atau kunjungi etalase resmi kami di Instagram, Shopee, dan TikTok Shop:
                </p>

                <div class="cq-contact-cards-stack">
                    <!-- Item 1: WhatsApp Customer Care (Fully Clickable Card) -->
                    <a href="<?php echo esc_url(cleaniquelab_get_whatsapp_url('Halo Cleanique Lab, saya ingin chat dengan customer care.')); ?>" target="_blank" rel="noopener" class="cq-contact-info-card cq-contact-wa-card" title="Chat WhatsApp Customer Care">
                        <div class="cq-contact-card-icon cq-wa-icon-bg">
                        ...
                        <div class="cq-contact-card-content">
                            <strong class="cq-contact-card-title">WhatsApp Hotline &amp; Konsultasi</strong>
                            <span class="cq-contact-card-subtitle">0878-4812-0088 (Respon Cepat)</span>
                            <span class="cq-contact-card-action">
                                Klik Chat WhatsApp Langsung &rarr;
                            </span>
                        </div>
                        <div class="cq-contact-card-arrow" aria-hidden="true">
                    ...
                    <div class="cq-contact-channels-grid">
                        ...
                        <a href="https://instagram.com/cleaniquelab" target="_blank" rel="noopener" class="cq-channel-card cq-channel-ig" title="Instagram @cleaniquelab">
                            ...
                            <div class="cq-channel-info">
                                <strong>Instagram</strong>
                                <span>@cleaniquelab</span>
                            </div>
                            <span class="cq-channel-badge" aria-hidden="true">&rarr;</span>
                        </a>
                    ...
                    <div class="cq-contact-info-card cq-contact-logistic-card">
                        <div class="cq-contact-card-icon cq-logistic-icon-bg">
                        ...
                        <div class="cq-contact-card-content">
                            <strong class="cq-contact-card-title">Workshop &amp; Pengiriman Nasional</strong>
                            <p class="cq-contact-card-desc">
            ...
            <div class="cq-contact-form-card">
                <h3 class="cq-contact-form-title">
                    Formulir Konsultasi Cepat
                </h3>
                <p class="cq-contact-form-lead">
                ...
                <form id="cq-contact-form" onsubmit="event.preventDefault(); window.cleaniqueSendContactWA();">
                    <div class="cq-form-group">
                        <label for="contact-name" class="cq-form-label">Nama Lengkap / Usaha:</label>
                        <input type="text" id="contact-name" required placeholder="Contoh: Budi Santoso / Laundry Berkah" class="cq-form-input">
                    </div>

                    <div class="cq-form-group">
                        <label for="contact-interest" class="cq-form-label">Minat Kebutuhan:</label>
                        <select id="contact-interest" class="cq-form-select">
                    ...
                    <div class="cq-form-group">
                        <label for="contact-message" class="cq-form-label">Pesan / Pertanyaan Tambahan:</label>
                        <textarea id="contact-message" rows="4" placeholder="Tuliskan kota Anda dan pertanyaan yang ingin diajukan..." class="cq-form-textarea"></textarea>
                    </div>

                    <button type="submit" class="cq-btn-primary cq-form-submit-btn">
...
<section class="cq-section cq-contact-map-section">
    <div class="cq-container">
        <div class="cq-contact-map-header-block">
            <span class="cq-spotlight-badge">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                Peta &amp; Titik Lokasi
            </span>
            <h2 class="cq-contact-map-h2">
                Lokasi Pabrik &amp; Workshop Cleanique Lab
            </h2>
            <p class="cq-contact-map-lead">
        ...
        <div class="cq-contact-map-grid">
            ...
            <div class="cq-contact-map-card">
                <div class="cq-contact-map-topbar">
                    <div class="cq-contact-map-status">
                        <span class="cq-status-dot"></span>
                        <strong>Google Maps &bull; PT Indotech Berkah Abadi</strong>
                    </div>
                    <a href="https://maps.app.goo.gl/cNvQcYrS57BvLqrc6" target="_blank" rel="noopener" class="cq-contact-map-link">
                        Buka Maps &rarr;
                    </a>
                </div>
                <div class="cq-contact-map-frame">
                    <iframe 
            ...
            <div class="cq-contact-address-card">
                <div>
                    <h3 class="cq-contact-address-title">
                    ...
                    <div class="cq-contact-address-details">
                        <div class="cq-address-item">
                            <span class="cq-address-label">Alamat Operasional:</span>
                            <p class="cq-address-text cq-address-bold">
                        ...
                        <div class="cq-address-item">
                            <span class="cq-address-label">Jam Operasional Workshop:</span>
                            <p class="cq-address-text">
                                <strong>Senin &ndash; Jumat:</strong> 08.00 &ndash; 17.00 WIB<br>
                                <strong>Sabtu:</strong> 08.00 &ndash; 15.00 WIB<br>
                                <span class="cq-text-holiday">Minggu &amp; Tanggal Merah: Libur (Pemesanan WA tetap dilayani)</span>
                            </p>
                        </div>

                        <div class="cq-address-item">
                            <span class="cq-address-label">Akses Kendaraan &amp; Muatan:</span>
                            <p class="cq-address-text cq-address-muted">
                ...
                <div class="cq-contact-address-actions">
                    <a href="https://maps.app.goo.gl/cNvQcYrS57BvLqrc6" target="_blank" rel="noopener" class="cq-btn-primary cq-address-btn">
                    ...
                    <a href="<?php echo esc_url(cleaniquelab_get_whatsapp_url('Halo Cleanique Lab, saya ingin buat janji temu / kunjungan ke workshop PT Indotech Berkah Abadi.')); ?>" target="_blank" rel="noopener" class="cq-btn-outline cq-btn-outline-dark cq-address-btn">
                        Janji Kunjungan
                    </a>
                </div>
            </div>
