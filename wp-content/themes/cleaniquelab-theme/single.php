        ...
        <div class="cq-container" style="max-width: 860px;">
            ...
            <div class="cq-share-bar">
                ...
                <div class="cq-share-buttons">
                    <!-- WhatsApp -->
                    <a href="<?php echo esc_url($share_url_wa); ?>" target="_blank" rel="noopener" class="cq-share-btn cq-share-wa" data-tooltip="WhatsApp" aria-label="Bagikan ke WhatsApp">
                    ...
                    <!-- Facebook -->
                    <a href="<?php echo esc_url($share_url_fb); ?>" target="_blank" rel="noopener" class="cq-share-btn cq-share-fb" data-tooltip="Facebook" aria-label="Bagikan ke Facebook">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <!-- Twitter/X -->
                    <a href="<?php echo esc_url($share_url_x); ?>" target="_blank" rel="noopener" class="cq-share-btn cq-share-x" data-tooltip="X (Twitter)" aria-label="Bagikan ke X">
                    ...
                    <!-- LinkedIn -->
                    <a href="<?php echo esc_url($share_url_in); ?>" target="_blank" rel="noopener" class="cq-share-btn cq-share-in" data-tooltip="LinkedIn" aria-label="Bagikan ke LinkedIn">
                    ...
                    <!-- Copy Link -->
                    <button type="button" class="cq-share-btn cq-share-copy" onclick="window.cleaniqueCopyArticleLink(this, '<?php echo esc_url($permalink); ?>');" data-tooltip="Salin Link" aria-label="Salin Tautan Artikel">
    ...
    <section class="cq-section" style="background-color: var(--cq-bg-soft); padding-top: 60px; padding-bottom: 70px;">
        <div class="cq-container">
            ...
            <div class="cq-flat-blog-grid">
                ...
                // Fallback to fetch any 3 published posts if category has fewer posts
